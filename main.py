...
header = ("  ______           _  __   __ _____  _____           _               \n" +
 		  " |  ____|         | | \ \ / // ____|/ ____|         | |              \n" +
...
def main():
	...
	parser = argparse.ArgumentParser(description='Spam pictures of Phil Mitchell and fake reports to XSSHunter collector instances.')
	parser.add_argument("hostname", help="Target XSSHunter collector hostname. e.g example.xss.ht")
